...
# installed.
TCL_PREFIX='E:/GenAILearning/myenv2\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/GenAILearning/myenv2\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/GenAILearning/myenv2\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/GenAILearning/myenv2\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/GenAILearning/myenv2\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/GenAILearning/myenv2\Library\lib\tclstub86.lib'
